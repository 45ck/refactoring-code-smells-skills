...
purpose: "Detect hidden dependencies such as ambient state, implicit IO, globals, framework magic, or time randomness coupling that harms predictability."
...
outputs: ["structured findings or risk review", "ranked recommendations or plan", "assumptions and unresolved questions", "recommended next skill"]
handoffs: ["dependency-simplifier", "global-state-risk-reviewer", "testability-refactor-planner"]
---
# hidden-dependency-detector

## Purpose
Detect hidden dependencies such as ambient state, implicit IO, globals, framework magic, or time randomness coupling that harms predictability.
