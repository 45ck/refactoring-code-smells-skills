...
purpose: "Reduce unnecessary coupling by identifying brittle dependencies, reducing fan-in or fan-out complexity, and clarifying module boundaries."
...
outputs: ["structured findings or refactor analysis", "ranked recommendations or plan", "assumptions and unresolved questions", "recommended next skill"]
handoffs: ["hidden-dependency-detector", "testability-refactor-planner", "refactoring-candidate-ranker"]
---
# dependency-simplifier

## Purpose
Reduce unnecessary coupling by identifying brittle dependencies, reducing fan-in or fan-out complexity, and clarifying module boundaries.
...
## Deliverables
- structured findings or refactor analysis
